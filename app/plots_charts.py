...
def build_chart_figure(df_all: pd.DataFrame, selected_indicator: str, selected_year: int):
    ...
    if selected_indicator in ["land_protected", "mountain_ecosystems"]:
        ...
        fig.update_layout(coloraxis_showscale=False, margin=dict(l=0, r=0, t=10, b=0), paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="rgba(0,0,0,0)", font_color="#555550", dragmode=False)
