...
def build_map_figure(gdf, selected_indicator: str):
    ...
    # Find whichever name column exists in this GDF
    ...
    fig_map.update_geos(visible=False, bgcolor="rgba(0,0,0,0)", projection_type="natural earth", lataxis_range=[-60, 85], lonaxis_range=[-180, 180])
    fig_map.update_layout(height=400, margin=dict(l=0, r=0, t=10, b=0), paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="rgba(0,0,0,0)", font_color="#555550")
